...
-- To enable/disable the script in game, type /swatbuddy
ScriptEnabled = false

 
-- Keys can be found here: https://docs.fivem.net/docs/game-references/controls/
-- To enable a command to open the menu, put a single command string below, example: "swatmenu"
ScriptKey = 84
ScriptCommand = "swatmenu"
