...
-- To enable/disable the script in game, type /statebuddy
ScriptEnabled = false

 
-- Keys can be found here: https://docs.fivem.net/docs/game-references/controls/
-- To enable a command to open the menu, put a single command string below, example: "statemenu"
ScriptKey = 84
ScriptCommand = "statemenu"


-- To change the uniform, simply change the ped name below.
ScriptUniform = "s_m_y_hwaycop_01"
