function StateBuddy_Spawn(Uniform)
    ...
    if DoesEntityExist(Buddy) then 
        TriggerEvent('StateBuddy:SetBuddy',Buddy)
...
RegisterNetEvent('StateBuddy:SetBuddy')
AddEventHandler('StateBuddy:SetBuddy', function(Bud)
