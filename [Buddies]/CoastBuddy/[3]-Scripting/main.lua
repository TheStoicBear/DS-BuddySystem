function CoastBuddy_Spawn(Uniform)
    ...
    if DoesEntityExist(Buddy) then 
        TriggerEvent('CoastBuddy:SetBuddy',Buddy)
...
RegisterNetEvent('CoastBuddy:SetBuddy')
AddEventHandler('CoastBuddy:SetBuddy', function(Bud)
