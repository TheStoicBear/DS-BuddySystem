function SheriffBuddy_Spawn(Uniform)
    ...
    if DoesEntityExist(Buddy) then 
        TriggerEvent('SheriffBuddy:SetBuddy',Buddy)
...
RegisterNetEvent('SheriffBuddy:SetBuddy')
AddEventHandler('SheriffBuddy:SetBuddy', function(Bud)
